...
import 'widgets/options_level_easy/option_a_level_easy.dart';
import 'widgets/options_level_easy/option_b_level_easy.dart';
import 'widgets/options_level_easy/option_c_level_easy.dart';

class QuestionsLevelEasy extends StatefulWidget {
  const QuestionsLevelEasy({super.key});

  @override
  State<QuestionsLevelEasy> createState() => _QuestionsLevelEasyState();
}

class _QuestionsLevelEasyState extends State<QuestionsLevelEasy>
            ...
            actions: [
              ...
              IconButton(
                onPressed: () async => await _speak(
                  "${easy.question!.substring(3)}."
                  "${'alternativeA'.tr()} ${easy.alternatives1!.substring(2)}."
                  "${'alternativeB'.tr()} ${easy.alternatives2!.substring(2)}."
                  "${'alternativeC'.tr()} ${easy.alternatives3!.substring(2)}.",
                  context,
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    TextQuestion(textQuestion: easy.question!),
                    const SizedBox(height: 5.0),
                    OptionALevelEasy(
                      onTap: () {
                        if (easy.alternatives1Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (easy.response1 == 'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (easy.response1 == 'Você Perdeu 5 Pontos!') {
                          enviarRanking(-5);
                        }
                        Navigator.of(context).pushReplacementNamed(
                          AppRoutes.alternative1LevelEasy, //ALTERNATIVA1,
                          arguments: easy,
                        );
                      },
                      easy: easy,
                    ...
                    OptionBLevelEasy(
                      onTap: () {
                        if (easy.alternatives2Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (easy.response2 == 'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (easy.response2 == 'Você Perdeu 5 Pontos!') {
                          enviarRanking(-5);
                        }
                        Navigator.of(context).pushReplacementNamed(
                          AppRoutes.alternative2LevelEasy, //ALTERNATIVA2,
                          arguments: easy,
                        );
                      },
                      easy: easy,
                    ...
                    OptionCLevelEasy(
                      onTap: () {
                        if (easy.alternatives3Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (easy.response3 == 'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (easy.response3 == 'Você Perdeu 5 Pontos!') {
                          enviarRanking(-5);
                        }
                        Navigator.of(context).pushReplacementNamed(
                          AppRoutes.alternative3LevelEasy, //ALTERNATIVA3,
                          arguments: easy,
                        );
                      },
                      easy: easy,
