...
import 'package:quiz_biblico_5/screens/level_game/sub_screens/questions_level_difficult/widgets/options_level_difficult/option_a_level_difficult.dart';
import 'package:quiz_biblico_5/screens/level_game/sub_screens/questions_level_difficult/widgets/options_level_difficult/option_b_level_difficult.dart';
import 'package:quiz_biblico_5/screens/level_game/sub_screens/questions_level_difficult/widgets/options_level_difficult/option_c_level_difficult.dart';
...
class QuestionsLevelDifficult extends StatefulWidget {
  const QuestionsLevelDifficult({super.key});

  @override
  State<QuestionsLevelDifficult> createState() =>
      _QuestionsLevelDifficultState();
}

class _QuestionsLevelDifficultState extends State<QuestionsLevelDifficult>
            ...
            actions: [
              ...
              IconButton(
                onPressed: () async => await _speak(
                  "${difficult.question!.substring(3)}."
                  "${'alternativeA'.tr()} ${difficult.alternatives1!.substring(2)}."
                  "${'alternativeB'.tr()} ${difficult.alternatives2!.substring(2)}."
                  "${'alternativeC'.tr()} ${difficult.alternatives3!.substring(2)}.",
                  context,
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    TextQuestion(textQuestion: difficult.question!),
                    const SizedBox(height: 5.0),
                    OptionALevelDifficult(
                      onTap: () {
                        if (difficult.alternatives1Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (difficult.response1 ==
                    ...
                    OptionBLevelDifficult(
                      onTap: () {
                        if (difficult.alternatives2Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (difficult.response2 ==
                            'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (difficult.response2 ==
                            'Você Perdeu 5 Pontos!') {
                    ...
                    OptionCLevelDifficult(
                      onTap: () {
                        if (difficult.alternatives3Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (difficult.response3 ==
                            'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (difficult.response3 ==
                            'Você Perdeu 5 Pontos!') {
                        ...
                        Navigator.of(context).pushReplacementNamed(
                          AppRoutes.alternative3LevelDifficult, //ALTERNATIVA3,
                          arguments: difficult,
                        );
                      },
                      difficult: difficult,
