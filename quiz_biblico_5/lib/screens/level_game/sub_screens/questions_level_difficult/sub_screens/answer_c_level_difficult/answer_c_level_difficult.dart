...
class AnswerCLevelDifficult extends StatelessWidget {
  const AnswerCLevelDifficult({super.key});

  @override
  Widget build(BuildContext context) {
    final difficult = ModalRoute.of(context)!.settings.arguments as VariablesGameModel;
