...
import 'package:quiz_biblico_5/screens/random_game/widgets/random_choose_question_number.dart';
...
import 'widgets/random_alternatives/random_alternative_a.dart';
import 'widgets/random_alternatives/random_alternative_b.dart';
import 'widgets/random_alternatives/random_alternative_c.dart';
...
class _RandomGameState extends State<RandomGame> {
  int currentQuestionIndexRandom = 0;
  bool isFinishedRandom = false;

  @override
  void initState() {
    super.initState();
    _loadCurrentQuestionRandom();
  }

  Future<void> _loadCurrentQuestionRandom() async {
    await PreferencesManager.instance.loadPreferences();
    setState(() {
      currentQuestionIndexRandom =
          PreferencesManager.instance.currentQuestionIndexRandom;
      isFinishedRandom = PreferencesManager.instance.isFinishedRandom;
    });
  }

  void nextQuestion() {
    setState(() {
      if (currentQuestionIndexRandom < RandomGameMock().random.length - 1) {
        currentQuestionIndexRandom++;
        PreferencesManager.instance.currentQuestionIndexRandom =
            currentQuestionIndexRandom; // Salvar o índice
      } else {
        isFinishedRandom = true;
        PreferencesManager.instance.isFinishedRandom =
  ...
  Future<void> resetProgressRandom() async {
    await PreferencesManager.instance.resetProgressRandom();
    setState(() {
      currentQuestionIndexRandom = 0;
      isFinishedRandom = false;
    });
  }
    ...
    return PreferencesManager.instance.isDirectQuestionMode
        ? SafeArea(
            child: Scaffold(
              ...
              body: RandomChooseQuestionNumber(),
            ),
          )
        : isFinishedRandom
        ? SafeArea(
        ...
        : RandomQuestions(
            ...
            randomQuestionsModel:
                RandomGameMock().random[currentQuestionIndexRandom],
          );
  }
}
...
class RandomQuestions extends StatefulWidget {
  ...
  @override
  State<RandomQuestions> createState() => _RandomQuestionsState();
}
    ...
    return SafeArea(
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBarDefault(
            text: '${'question'.tr()} ${widget.randomQuestionsModel?.id}',
            ...
            actions: [
              ...
              IconButton(
                onPressed: () async => await _speak(
                  "${widget.randomQuestionsModel?.question!.substring(3)}."
                  " ${'alternativeA'.tr()}. ${widget.randomQuestionsModel?.alternatives1!.substring(2)}."
                  " ${'alternativeB'.tr()}. ${widget.randomQuestionsModel?.alternatives2!.substring(2)}."
                  " ${'alternativeA'.tr()}. ${widget.randomQuestionsModel?.alternatives3!.substring(2)}.",
                  context,
                ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextQuestion(
                                    textQuestion:
                                        widget.randomQuestionsModel!.question!,
                                  ),
                                  ...
                                  RandomAlternativeA(
                                    onTap: () {
                                      Navigator.of(context).pushNamed(
                                        AppRoutes
                                            .alternative1Random, //ALTERNATIVA1,
                                        arguments: widget.randomQuestionsModel!,
                                      );
                                    },
                                    randomQuestionsModel:
                                        widget.randomQuestionsModel!,
                                  ),
                                  const SizedBox(height: 5.0),
                                  RandomAlternativeB(
                                    onTap: () async {
                                      Navigator.of(context).pushNamed(
                                        AppRoutes
                                            .alternative2Random, //ALTERNATIVA2,
                                        arguments: widget.randomQuestionsModel!,
                                      );
                                    },
                                    randomQuestionsModel:
                                  ...
                                  RandomAlternativeC(
                                    onTap: () async {
                                      ...
                                      Navigator.of(context).pushNamed(
                                        AppRoutes
                                            .alternative3Random, //ALTERNATIVA3,
                                        arguments: widget.randomQuestionsModel!,
                                      );
                                    },
                                    randomQuestionsModel:
