...
import 'package:quiz_biblico_5/screens/random_game/widgets/random_alternatives/random_alternative_a.dart';
import 'package:quiz_biblico_5/screens/random_game/widgets/random_alternatives/random_alternative_b.dart';
import 'package:quiz_biblico_5/screens/random_game/widgets/random_alternatives/random_alternative_c.dart';
    ...
    return SafeArea(
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBarDefault(
            text: '${'question'.tr()} ${randomQuestionsModel.id}',
            ...
            actions: [
              ...
              IconButton(
                onPressed: () async => await _speak(
                  "${randomQuestionsModel.question!.substring(3)}."
                  " ${'alternativeA'.tr()} ${randomQuestionsModel.alternatives1!.substring(2)}."
                  " ${'alternativeB'.tr()} ${randomQuestionsModel.alternatives2!.substring(2)}."
                  " ${'alternativeC'.tr()} ${randomQuestionsModel.alternatives3!.substring(2)}.",
                  context,
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    TextQuestion(textQuestion: randomQuestionsModel.question!),
                    const SizedBox(height: 5.0),
                    RandomAlternativeA(
                      onTap: () {
                        if (randomQuestionsModel.alternatives1Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (randomQuestionsModel.response1 ==
                        ...
                        Navigator.of(context).pushReplacementNamed(
                          AppRoutes.alternative1Random, //ALTERNATIVA1,
                          arguments: randomQuestionsModel,
                        );
                      },
                      randomQuestionsModel: randomQuestionsModel,
                    ),
                    const SizedBox(height: 5.0),
                    RandomAlternativeB(
                      onTap: () {
                        if (randomQuestionsModel.alternatives2Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (randomQuestionsModel.response2 ==
                            'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (randomQuestionsModel.response2 ==
                            'Você Perdeu 5 Pontos!') {
                    ...
                    RandomAlternativeC(
                      onTap: () {
                        if (randomQuestionsModel.alternatives3Imagem! ==
                            'images/balloons.png') {
                          enviarRanking(10);
                        } else if (randomQuestionsModel.response3 ==
                            'Você Perdeu 2 Pontos!') {
                          enviarRanking(-2);
                        } else if (randomQuestionsModel.response3 ==
                            'Você Perdeu 5 Pontos!') {
                        ...
                        Navigator.of(context).pushReplacementNamed(
                          AppRoutes.alternative3Random, //ALTERNATIVA3,
                          arguments: randomQuestionsModel,
                        );
                      },
                      randomQuestionsModel: randomQuestionsModel,
