...
class RandomAlternativeA extends StatelessWidget {
  final VariablesGameModel randomQuestionsModel;
  final Function()? onTap;

  const RandomAlternativeA({
    super.key,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: Provider.of<ThemeChanger>(context).themeType ==
                ...
                : Colors.white24, // const Color.fromRGBO(255, 145, 77, 10),
            border: const Border(
              top: BorderSide(
                //                    <--- top side
                color: Colors.white,
          ...
          child: AutoSizeText(
            randomQuestionsModel.alternatives1!,
            style: const TextStyle(
              color: Colors.white,
              fontFamily: 'FredokaOne',
              fontSize: 22, //isLandscape! ? constraints!.maxHeight * 0.05 :
